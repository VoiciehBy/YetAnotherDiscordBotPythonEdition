...
commands = ["siema", "won", "połącz", "pomoc","graj"];
commands_desc = ["wyświetla " + "'" + hiReply + "'", "rozłącza bota", "podłącza bota do serwera głosowego", "wyświetla pomoc","odtwarza pewną pieśń"];